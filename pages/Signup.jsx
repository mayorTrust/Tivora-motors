...
import { UserPlus, Mail, Lock, ShieldPlus, ArrowRight, Chrome, Loader2 } from 'lucide-react';
...
const Signup = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen relative overflow-hidden px-4 py-12 bg-background">
      <div className="absolute top-1/4 -right-20 w-96 h-96 bg-radial-gradient opacity-10 blur-3xl pointer-events-none" />
      <div className="absolute bottom-1/4 -left-20 w-96 h-96 bg-radial-gradient opacity-10 blur-3xl pointer-events-none" />
      ...
      >
        <div className="flex flex-col items-center mb-10">
          <div className="w-20 h-20 bg-white/5 rounded-3xl flex items-center justify-center mb-6 border border-white/10 shadow-inner">
            <ShieldPlus className="w-10 h-10 text-[#00f2ff]" />
          </div>
          <h2 className="text-4xl font-black italic tracking-tighter text-white uppercase mb-2">New Identity</h2>
          <p className="text-gray-500 text-[10px] font-black uppercase tracking-[0.2em]">Provisioning Network Access</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-5">
          <div className="group">
            <label className="block text-[10px] font-black uppercase tracking-[0.3em] text-gray-600 mb-3 px-1" htmlFor="email">Preferred ID</label>
          ...
          <div className="group">
            <label className="block text-[10px] font-black uppercase tracking-[0.3em] text-gray-600 mb-3 px-1" htmlFor="confirmPassword">Verify Key</label>
            <div className="relative">
              <Lock className="absolute left-5 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-600 group-focus-within:text-[#00f2ff] transition-colors" />
              <input
                type="password"
        ...
        <div className="relative my-10">
          ...
          <div className="relative flex justify-center text-[8px] font-black uppercase tracking-[0.4em]">
            <span className="bg-[#050505] px-4 text-gray-600">Rapid Provisioning</span>
          </div>
        </div>
        ...
        <p className="text-center text-gray-600 text-[10px] font-black uppercase tracking-widest">
          Active Operative?{' '}
          <Link to="/login" className="text-[#00f2ff] hover:text-white transition-colors">Secure Login</Link>
        </p>
      </div>
    </div>
  );
